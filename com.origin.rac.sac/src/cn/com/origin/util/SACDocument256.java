...
public class SACDocument256 extends PlainDocument {
	...
	public SACDocument256() {
		super();
		this.init();
	}

	public SACDocument256(Content c) {
		super(c);
		this.init();
	}
	...
	public void insertString(int offs, String str, AttributeSet a)
		...
		try {
			...
			{
				MessageBox.post("您文本区域输入的内容长度超过了256", "提示", MessageBox.INFORMATION);
