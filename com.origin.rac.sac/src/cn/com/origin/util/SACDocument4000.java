...
public class SACDocument4000 extends PlainDocument {
	...
	public SACDocument4000() {
		super();
		this.init();
	}

	public SACDocument4000(Content c) {
		super(c);
		this.init();
	}
	...
	public void insertString(int offs, String str, AttributeSet a)
		...
		try {
			if(getText(0, getLength()).getBytes().length+str.getBytes().length <=4000)
			{
				super.insertString(offs, new String(str).trim(), a);
			}else
			{
				MessageBox.post("您文本区域输入的内容长度超过了4000", "提示", MessageBox.INFORMATION);
