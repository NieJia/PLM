...
public class S4GYLXToErpCommand extends AbstractAIFCommand{
	...
	public S4GYLXToErpCommand(AbstractAIFUIApplication app, InterfaceAIFComponent target){
		this.app = app;
		this.target = target;
	...
	public void executeModal() throws Exception {
		S4GYLXToErpDialog dialog = new S4GYLXToErpDialog(this, app, session);
		setRunnable(dialog);
	}
}
