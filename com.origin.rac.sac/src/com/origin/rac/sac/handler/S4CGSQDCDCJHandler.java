...
import com.origin.rac.sac.cgsqdcd.S4CGSQDCDCJAction;
...
public class S4CGSQDCDCJHandler extends AbstractHandler {
	...
	public Object execute(ExecutionEvent arg0) throws ExecutionException {
		...
		if(targets.length == 1)
		{
			...
			if(target instanceof TCComponentItem)
			{
				...
				{
					S4CGSQDCDCJAction action = new S4CGSQDCDCJAction(app,null,"",targetitem);
