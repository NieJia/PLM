...
import com.origin.rac.sac.eco.S4ECOCheckingAction;
...
public class S4ECOCheckingHandler extends AbstractHandler{
					...
					try {
						...
						if(!(release == null || release.equals(""))){
							...
							if(release.equals("Released")){
								S4ECOCheckingAction s4ECOCheckingAction = new S4ECOCheckingAction(app, tccomponentItemRevision, null);
								new Thread(s4ECOCheckingAction).start();
							}
							else{
